						...
						<table>
							<tr>
								<td><span class="input-icon"> <input
										...
										name="owner" id="owner" value="${pd.owner}"
										placeholder="输入条件：所有者" /> <i id="nav-search-icon"
										class="icon-search"></i> </span>
										</td>
								<td><span class="input-icon"> <input
										autocomplete="off" id="nav-search-input" type="text"
										name="key" id="key" value="${pd.key}" placeholder="输入条件：关键词" />
											...
											<c:forEach items="${varList}" var="var" varStatus="vs">
												<tr>
													<td class='center' style="width: 30px;"><label><input
															type='checkbox' name='ids' value="${var.CARDINFO_ID}" /><span
															class="lbl"></span>
													</label></td>
