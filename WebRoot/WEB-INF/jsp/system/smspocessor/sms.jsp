...
<form action="smspocessor/doSend.do"  name="Form" id="Form" method="post">
				<input type="hidden" name="TYPE" id="TYPE" value="1"/>
				<table style="width:100%;" id="xtable">
					<tr>
						<td style="margin-top:0px;">
							 <div style="float: left;width:86%"><textarea name="PHONE" id="PHONE" rows="1" cols="50" style="width:100%;height:20px;" placeholder="请选输入对方卡号,多个请用(;)分号隔开" title="请选输入对方卡号,多个请用(;)分号隔开"></textarea></div>
							 <div style="float: right;width:10%"><a class='btn btn-mini btn-info' title="编辑卡号" onclick="dialog_open();"><i class='icon-edit'></i></a></div>
						</td>
					</tr>
					<tr>
						<td>
						<div style="float: left;width:86%"><textarea name="CONTENT" id="CONTENT" rows="1" cols="50" style="width:100%;height:20px;" placeholder="请选输入短信内容" title="请选输入短信内容"></textarea></div>
						</td>
					</tr>
					<tr>
