...
public class TCPIPConnection extends Connection {
	...
	public TCPIPConnection(int port) {
		if ((port >= SmsConstant.MIN_VALUE_PORT)
				&& (port <= SmsConstant.MAX_VALUE_PORT)) {
	...
	public TCPIPConnection(String listenIp, int listenPort) {
		...
		if ((listenPort >= SmsConstant.MIN_VALUE_PORT)
				&& (listenPort <= SmsConstant.MAX_VALUE_PORT)) {
	...
	public TCPIPConnection(String remoteAddress, int remotePort,
		...
		if ((remotePort >= SmsConstant.MIN_VALUE_PORT)
				&& (remotePort <= SmsConstant.MAX_VALUE_PORT)) {
