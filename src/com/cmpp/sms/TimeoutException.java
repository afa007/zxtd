...
public class TimeoutException extends SmsException {
	...
	/**
	 * Construct with provided timeout and expected and received amount of data.
	 */
	public TimeoutException(long timeout, int expected, int received) {
		super("The rest of pdu not received for " + (timeout / 1000)
				+ " seconds. " + "Expected " + expected + " bytes, received "
				+ received + " bytes.");
