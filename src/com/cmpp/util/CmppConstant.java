...
public class CmppConstant {
    ...
    public static final int PDU_HEADER_SIZE = 12;

    // CMPP Version
    public static final byte PROTOCALTYPE_VERSION_CMPP2 = 32;
    public static final byte PROTOCALTYPE_VERSION_CMPP3 = 48;
    ...
    public static final String SERVICE_ID_MMS = "mms";
