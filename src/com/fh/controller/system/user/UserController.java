...
public class UserController extends BaseController {
	...
	public ModelAndView goAddU() throws Exception {
		...
		List<Role> roleList;
		if ("fd943b1825224e568c48e3517fda2add".equals(user.getROLE_ID())
				|| "1c21fe26b9b34e86858a5801a2c75e8a".equals(user.getROLE_ID())
				|| "4".equals(user.getROLE_ID())) {
			roleList = roleService.listAllERRolesSecondGroup(); // 列出所有二级角色
		} else {
	...
	public ModelAndView listUsers(Page page) throws Exception {
		...
		if ("fd943b1825224e568c48e3517fda2add".equals(user.getROLE_ID())
				|| "1c21fe26b9b34e86858a5801a2c75e8a".equals(user.getROLE_ID())
				|| "4".equals(user.getROLE_ID())) {
			List<PageData> userList = userService
					.listPdPageUserSecondGroup(page); // 列出用户列表
			List<Role> roleList = roleService.listAllERRolesSecondGroup(); // 列出所有二级角色
