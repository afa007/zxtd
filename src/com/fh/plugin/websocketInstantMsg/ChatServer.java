...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("ZXTD290119597")){
			this.userjoin(message.replaceFirst("ZXTD290119597", ""),conn);
		}if(null != message && message.startsWith("LeaveZXTD290119597")){
			this.userLeave(conn);
