...
public class SimpleMailSender extends BaseController {
	...
	public boolean sendMail(String title, String content, String type,
		...
		mailInfo.setUserName("290119597");
		mailInfo.setPassword("ccIvv@2058.com");// 您的邮箱密码
		mailInfo.setFromAddress("290119597@qq.com");
	...
	public static void main(String[] args) {
		...
		mailInfo.setMailServerPort("25");
		mailInfo.setValidate(true);
		mailInfo.setUserName("18830696669@163.com");
		mailInfo.setPassword("86581214");// 您的邮箱密码
		mailInfo.setFromAddress("18830696669@163.com");
		mailInfo.setToAddress("290119597@163.com");
		mailInfo.setSubject("ZXTD");
		mailInfo.setContent("test <b>from</b> ZXTD");
		// 这个类主要来发送邮件
